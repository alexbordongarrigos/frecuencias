    ...
    <div className="bg-black/30 border border-white/10 rounded-xl p-4 flex flex-col gap-4 hover:border-cyan-500/30 transition-all shadow-lg">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
        ...
        <div className="space-y-3">
            <div className="flex justify-between items-center text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                <span>Volumen</span>
                <span className="text-purple-300 font-mono bg-black/60 px-3 py-1.5 rounded-xl border border-purple-500/30 shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]">{Math.round(osc.volume * 100)}%</span>
            </div>
            <input 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 relative z-10">
                ...
                <div className="space-y-3 bg-black/40 p-3 rounded-xl border border-white/5 shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]">
                    <div className="flex justify-between text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                        <span>L</span>
                        <span className="text-cyan-400 drop-shadow-[0_0_5px_rgba(34,211,238,0.8)] bg-cyan-500/10 px-2 py-0.5 rounded border border-cyan-500/20">X</span>
                        <span>R</span>
                    </div>
                    <input 
                ...
                <div className="space-y-3 bg-black/40 p-3 rounded-xl border border-white/5 shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]">
                    <div className="flex justify-between text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                        <span>Atrás</span>
                        <span className="text-purple-400 drop-shadow-[0_0_5px_rgba(168,85,247,0.8)] bg-purple-500/10 px-2 py-0.5 rounded border border-purple-500/20">Z</span>
                        <span>Frente</span>
                    </div>
                    <input 
                ...
                <div className="space-y-3 bg-black/40 p-3 rounded-xl border border-white/5 shadow-[inset_0_0_10px_rgba(0,0,0,0.5)]">
                    <div className="flex justify-between text-[10px] text-slate-400 font-bold uppercase tracking-widest">
                        <span>Abajo</span>
                        <span className="text-pink-400 drop-shadow-[0_0_5px_rgba(236,72,153,0.8)] bg-pink-500/10 px-2 py-0.5 rounded border border-pink-500/20">Y</span>
                        <span>Arriba</span>
                    </div>
                    <input 
        ...
        <div className="md:col-span-2 space-y-4 pt-4 bg-black/40 rounded-2xl p-5 border border-white/10 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] relative overflow-hidden">
            ...
            {osc.transition?.enabled && (
                <div className="space-y-5 mt-4 relative z-10">
                    ...
                    {/* Playback Controls */}
                    <div className="flex items-center gap-6 bg-black/40 p-5 rounded-2xl border border-white/10 shadow-[inset_0_0_20px_rgba(0,0,0,0.5)] relative overflow-hidden">
